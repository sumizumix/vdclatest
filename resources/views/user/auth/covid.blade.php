            ...
            <div class="col-lg-12 col-sm-12 position-relative page-title-extra-small">
                <h2 class="m-auto pb-5px pt-5px text-white fw-600 ls-minus-1px overflow-hidden text-center">
                    <span class="d-inline-block"
                        data-anime='{ "translateY": [30, 0], "opacity": [0, 1], "easing": "easeOutCubic", "duration": 500, "staggervalue": 300 }'>Covid-19
                        Test</span>
                </h2>
...
<section class="bg-vdc-light-purple -mt-60px">
    <div class="container">
        <div class="row align-items-center"
            data-anime='{ "translateY": [0, 0], "opacity" : [0,1], "duration"
            : 600, "delay" : 0, "staggervalue" : 300, "easing" : "easeOutQuad" }'>
            <div class="col-12">
                <div class="border-radius-6px overflow-hidden position-relative">
                    <span
                        class="text-uppercase text-base-color fs-14 lh-40 fw-700 border-radius-100px bg-gradient-light-gray-transparent d-inline-flex">
                    ...
                    <div class="accordion accordion-style-02" id="accordion-style-02"
                        ...
                        <div class="accordion-item active-accordion">
                            ...
                            <div id="accordion-style-02-01" class="accordion-collapse collapse show"
                                ...
                                <div
                                    class="accordion-body text-base-color fw-600 last-paragraph-no-margin border-bottom border-color-transparent-dark-very-light">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="accordion-style-02-03" class="accordion-collapse collapse"
                                data-bs-parent="#accordion-style-02">
                                <div
                                    class="accordion-body text-base-color fw-600 last-paragraph-no-margin border-bottom border-color-transparent">
                                    <p class="w-90 sm-w-95 xs-w-100">
