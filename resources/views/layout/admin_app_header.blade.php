                        ...
                        <div class="message-body">
                            <div>
                                <a href="#" class="process-step-item d-flex align-items-center"
                                    data-bs-toggle="modal" data-bs-target="#bookSampleModal">
...
<div class="modal fade" id="bookSampleModal" tabindex="-1" aria-labelledby="bookSampleModalLabel" aria-hidden="true"
    style="background-color: rgba(0, 0, 0, 0.8)">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body p-40px">
                <div class="modal-header p-0 border-0 pb-20px mb-3">
                ...
                <form id="passwordForm" action="{{ url('admin/about/updateprofile') }}" method="POST"
