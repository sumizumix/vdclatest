                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ url('admin/product/update/' . $product->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div id="test-div">
                                ...
                                <div class="mb-3 parameter-row">
                                    <div class="row justify-content-evenly align-items-center d-flex">
                                        <label class="form-label" for="parameter">Test Name</label>
                                        <div class="col-6">
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="noparameter">Number of parameters</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="reporttime" name="reporttime" value="{{ $product->reporttime }}">
                            </div>
                            <div class="mb-3">
                            ...
                            <button type="submit" class="btn btn-primary"><i class="fa fa-plus"></i> Edit Package</button>
                        </form>
                    </div>
                </div>
            </div>
