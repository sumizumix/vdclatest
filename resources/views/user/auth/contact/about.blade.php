        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-6"
                ...
                <h6 class="mb-20px xs-mb-20px text-base-color fs-18 fw-600 text-shadow-medium text-uppercase">
                    <span
                        class="w-30px h-3px bg-yellow d-inline-block align-middle position-relative top-minus-2px me-8px"></span>why
                    vdc
                </h6>
            ...
            <div class="col-lg-5 col-md-5 offset-lg-1 md-mt-50px animation-float"
        ...
        <div class="container">
            ...
            <div class="row justify-content-center appear anime-child anime-complete"
                ...
                <div class="col-lg-6 col-md-9 icon-with-text-style-02 transition-inner-all mb-30px" style="">
                    <div
                        class="feature-box feature-box-left-icon-middle d-flex flex-column  text-start hover-box dark-hover box-shadow-extra-large box-shadow-extra-large-hover bg-white h-100 border-radius-4px p-9 overflow-hidden last-paragraph-no-margin -border-start -border-warning -border-4">
                        <div class="feature-box-icon align-self-start mb-20px">
                            <i class="fa-solid fa-eye icon-double-large text-base-color"></i>
                        </div>
                        <div class="feature-box-content">
                            <span
                                class="d-inline-block text-base-color fw-600 mb-5px fs-24 ps-2 ls-minus-05px border-start border-4 border-warning">
                                Vision
                            </span>
                ...
                <div class="col-lg-6 col-md-9 icon-with-text-style-02 transition-inner-all mb-30px" style="">
                    <div
                        class="feature-box feature-box-left-icon-middle d-flex flex-column  text-start hover-box dark-hover box-shadow-extra-large box-shadow-extra-large-hover bg-white h-100 border-radius-4px p-9 overflow-hidden last-paragraph-no-margin">
                        <div class="feature-box-icon align-self-start mb-20px">
                            <i class="fa-solid fa-bullseye icon-double-large text-base-color"></i>
                        </div>
                        <div class="feature-box-content">
                            <span
                                class="d-inline-block text-base-color fw-600 mb-5px fs-24 ls-minus-05px border-start border-4 border-warning ps-2">
                                Mission
                            </span>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6 text-center text-md-start sm-mb-20px"
                ...
                <h6 class="mb-20px xs-mb-20px text-base-color fs-18 fw-600 text-shadow-medium text-uppercase">
                    <span
                        class="w-30px h-3px bg-yellow d-inline-block align-middle position-relative top-minus-2px me-8px"></span>
                    vdc
                </h6>
                    ...
                    <div class="swiper-wrapper pt-20px pb-20px">
                        @foreach ($hospital as $row)
                            <div class="swiper-slide">
                                <div
                                    class="feature-box justify-content-between border-bottom border-2 border-color-base-color text-start p-0 border-radius-6px bg-white">
                                    <img src="{{ asset('uploads/' . $row->image) }}"
                                        class="w-100 h-250px object-fit-cover" />
                                    <div class="feature-box-content min-h-200px p-20px">
                                        <h4 class="fw-700 lh-sm mb-10px text-base-color fs-20 line-2">
                                            {{ $row->name }}
                                        </h4>

                                        <div class="d-flex mb-10px lh-sm fs-15 fw-500 text-base-color">
                                            <i class="bi bi-geo-alt me-10px"></i>
                                            <span class="text-dark-gray">{{ $row->address }}</span>
                                        </div>

                                        <div class="d-flex mb-10px lh-sm fs-15 fw-500">
                                            <i class="bi bi-telephone-inbound me-10px text-base-color"></i>
                                            <a href="tel:{{ $row->phone }}" class="text-dark-gray">{{ $row->phone }}</a>
                                        </div>

                                        <p class="mb-10px lh-sm fs-15 fw-500 ">
                                            <i class="bi bi-envelope-at me-10px text-base-color"></i>
                                            <a href="mailto:{{ $row->website }}" class="text-dark-gray">{{ $row->website }}</a>
                                        </p>

                                        <p class="mb-10px lh-sm fs-15 fw-500 ">
                                            <i class="bi bi-globe me-10px text-base-color"></i>
                                            <a href="http://www.vdc.com" class="text-dark-gray">www.vdc.com</a>
                                        </p>
                            ...
                            <div class="swiper-slide">
                                <div
                                    ...
                                    <div class="position-relative box-image">
                                        <img src="{{ asset('uploads/' . $row->image) }}" class="img-fluid h-img"
                                            alt />
                                    </div>
                                    <div class="bg-white border-bottom border-warning border-4"
                                        ...
                                        <div class="ps-30px min-h-150px pe-30px pt-35px sm-p-35px sm-pb-0">
                                            ...
                                            <div class="row">
                                                ...
                                                <span class="card-text"><strong><i
                                                            class="fa-solid fa-tag -icon-double-large text-base-color fs-14"></i></strong>
